...
class BreezeForConditionalGeneration(BreezePreTrainedModel, BreezeGenerationMixin):
    ...
    def __init__(self, config):
        ...
        if getattr(config, "text_encoder_config", None) is not None:
            ...
            text_encoder_attn_implementation = getattr(config, "_attn_implementation", "eager")
            ...
            config.text_encoder_config.preferred_attn_implementation = text_encoder_attn_implementation
